            ...
            <div className="p-6 sm:p-8 space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div className="col-span-2">
                  ...
                  <span className="font-medium text-[15px]" style={{ color: "var(--fg)" }}>
                    Approved a $4,200 payout
                  </span>
                </div>
                <div>
                  <span className="type-eyebrow block mb-1">On</span>
                  <span className="font-medium text-sm" style={{ color: "var(--fg)" }}>
                    Claim {receiptData.claim_id}
                  </span>
                </div>
                <div>
                  <span className="type-eyebrow block mb-1">When</span>
                  <span className="text-sm tnum" style={{ color: "var(--fg)" }}>
                    Sep 1, 14:32 UTC
                  </span>
                </div>
                <div>
                ...
                <div className="col-span-2">
                  ...
                  <span className="font-medium text-sm" style={{ color: "var(--fg)" }}>
                    {receiptData.principal_authorizer}
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-3 pt-1">
                ...
                <div>
                  ...
                  >
                    {expandedHex
                      ? receiptData.event_sha256
                      : `${receiptData.event_sha256.slice(0, 22)}…${receiptData.event_sha256.slice(-16)}`}
                  </div>
                </div>
                ...
                <div>
                  ...
                  >
                    {expandedHex
                      ...
                      : `${receiptData.signature.slice(0, 26)}…${receiptData.signature.slice(-16)}`}
                  </div>
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  <span>Signed and time-stamped</span>
                </div>
