...
const (
	AnalyticsService_GetOverview_FullMethodName = "/solari.ledger.v1.AnalyticsService/GetOverview"
)
...
func (c *analyticsServiceClient) GetOverview(ctx context.Context, in *GetOverviewRequest, opts ...grpc.CallOption) (*GetOverviewResponse, error) {
...
func (UnimplementedAnalyticsServiceServer) GetOverview(context.Context, *GetOverviewRequest) (*GetOverviewResponse, error) {
...
func _AnalyticsService_GetOverview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyticsServiceServer).GetOverview(ctx, req.(*GetOverviewRequest))
	}
...
var AnalyticsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "solari.ledger.v1.AnalyticsService",
	...
	Metadata: "solari/ledger/v1/analytics.proto",
}
