...
const file_solari_ledger_v1_delegation_proto_rawDesc = "" +
	...
	"\x05scope\x18\x04 \x01(\v2\x17.solari.ledger.v1.ScopeR\x05scope:\xd2\x01\x92A\xce\x012\xcb\x01{\"parent_grant_id\":\"BAL-417849\",\"subject_id\":\"agt_shopper\",\"capabilities\":[\"browser.click\",\"browser.type\"],\"scope\":{\"resource_globs\":[\"https://shop.example.com/*\"],\"max_value_cents\":50000,\"max_depth\":2}}\"A\n" +
