...
type EventStore interface {
	...
	List(ctx context.Context, projectID string, pageSize int32, pageToken string) ([]*ledgerv1.ActionEvent, string, error)
}
...
type GrantStore interface {
	...
	List(ctx context.Context, projectID string, pageSize int32, pageToken string) ([]*ledgerv1.Grant, string, error)
}
...
type SessionStore interface {
	...
	List(ctx context.Context, projectID string, pageSize int32, pageToken string) ([]*ledgerv1.Session, string, error)
}
